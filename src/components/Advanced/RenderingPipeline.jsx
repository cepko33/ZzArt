            ...
            <div class={nodeClass}>
                <div class="node-header">
                    ...
                    <div class="node-params">
                        {this.tags?.map((tag) => (
                            <span class="node-param-tag active" title={tag.title}>
                                {tag.label}
                            </span>
                        ))}
                    </div>
                ...
                {this.copyCode && (
                    <button
                        class="copy-btn"
                        onClick={() => navigator.clipboard.writeText(this.copyCode)}
                    >
                        Copy Code
                    </button>
                )}
            ...
            <details class="advanced-group">
                ...
                <div id="pipeline_container" class="pipeline-container">
                    <div class="pipeline-flow">
                        ...
                        <div
                            id="feedback_loop_container"
                            class="feedback-loop-container"
                            style={{ opacity: fsActive.useFeedback ? 1 : 0.3 }}
                        >
                            <svg
                                class="feedback-svg"
                                viewBox="0 0 100 100"
                                style={{ opacity: fsActive.useFeedback ? 1 : 0 }}
                            >
                                <path
                                    id="feedback_loop_path"
                                    class="feedback-path"
                                    d="M 80,50 C 110,50 110,-50 80,-50"
                                    transform="translate(-10, 50) rotate(-90, 50, 50)"
                                ></path>
                            </svg>
                            ...
                            <PipelineNode
                                ...
                                tags={[
                                    {
                                        label: `Blend: ${fsActive.feedbackBlendMode}`,
                                        title: 'Blend Mode',
                                    },
                                    {
                                        label: `Mask: ${fsActive.feedbackMaskType}`,
                                        title: 'Mask Type',
                                    },
                                ]}
                        ...
                        <div
                            class="buffer-nodes"
                            style={{ opacity: fsActive.useFeedback ? 1 : 0.2 }}
                        >
                            <div class="buffer-tag history">
                                <b>HIST A</b> (Buff 1)
                            </div>
                            <div class="buffer-tag history">
                                <b>HIST B</b> (Buff 2)
                        ...
                        <div
                            class="pipeline-connection pulse"
                            style={{ opacity: fsActive.useFeedback ? 1 : 0.2 }}
                        ></div>

                        <PipelineNode
                            title="📺 OUTPUT (PASS 3)"
                            tags={[{ label: 'Screen Blit', title: 'Screen Blit' }]}
                            color="#5AF"
                        >
                ...
                <textarea
                    disabled
                    hidden={!state.ui.textareaDebug}
                    value={state.ui.textareaDebug}
                    style={{ color: '#F00' }}
                    rows={4}
                ></textarea>
