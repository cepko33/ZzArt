                ...
                >
                    {state.saveList.map((s, i) => (
                        <option key={i} value={i}>
                            {s.GetGenerationString()}
                        </option>
                    ))}
                </select>

                <div class="buttons-group">
                    <button class="action-button" onClick={OpenCapJS}>
                        CapJS
                    </button>
                    <button class="action-button" onClick={ExportSaveList}>
                        Export
                    </button>
                    <button
                        class="action-button"
                        onClick={() => document.getElementById('input_importFile').click()}
                    >
                        Import
                    </button>
                    <input id="input_importFile" type="file" style={{ display: 'none' }} />
                    <button class="action-button danger" onClick={DeleteSelectedSave}>
                        Delete
                    </button>
                </div>
            </div>
